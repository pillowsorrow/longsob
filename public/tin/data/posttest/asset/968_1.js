...
bsscript.src = '../../node_modules/bootstrap/dist/js/bootstrap.bundle.min.js';

var bscss = document.createElement('link');
bscss.rel = 'stylesheet';
bscss.href = '../../node_modules/bootstrap/dist/css/bootstrap.min.css';
...
//* Question: 1********************
question[0] = 'โมเดล STRONG ให้นำ S (Sufficient) ไปใช้ในการปฏิบัติหน้าที่ของตนเองอย่างไร';
question_score[0] = '1';
choice[0] = new Array();

//* Question: 2********************
question[1] = 'โมเดล STRONG ให้นำ T (Transparent) ไปใช้ในการปฏิบัติหน้าที่ของตนเองอย่างไร ';
question_score[1] = '1';
choice[1] = new Array();

//* Question: 3********************
question[2] = 'โมเดล STRONG ให้นำ R (Realize) ไปใช้ในการปฏิบัติหน้าที่ของตนเองอย่างไร   ';
question_score[2] = '1';
choice[2] = new Array();

//* Question: 4********************
question[3] = 'โมเดล STRONG ให้นำ O (Onward) ไปใช้ในการปฏิบัติหน้าที่ของตนเองอย่างไร ';
question_score[3] = '1';
choice[3] = new Array();

//* Question: 5********************
question[4] = 'โมเดล STRONG ให้นำ N (Knowledge) ไปใช้ในการปฏิบัติหน้าที่ของตนเองอย่างไร ';
question_score[4] = '1';
choice[4] = new Array();

//* Question: 6********************
question[5] = 'โมเดล STRONG ให้นำ G (Generosity) ไปใช้ในการปฏิบัติหน้าที่ของตนเองอย่างไร ';
question_score[5] = '1';
choice[5] = new Array();

//* Question: 7********************
question[6] = 'การน้อมนำปรัชญาเศรษฐกิจพอเพียง มาใช้เป็นแนวทางในการดำเนินชีวิต จะทำให้อยู่ในสังคมอย่างมีความสุขได้ เพราะเหตุใด';
question_score[6] = '1';
choice[6] = new Array();

//* Question: 8********************
question[7] = '"ในหลวงรัชกาลที่ 9 นั้น ไม่เพียงแต่จะทรงเป็นผู้คิดค้นหลักเศรษฐกิจพอเพียงเท่านั้น พระองค์เองยังเป็นแบบอย่างของความพอเพียงอีกด้วย" คำกล่าวนี้เป็นจริงหรือไม่';
question_score[7] = '1';
choice[7] = new Array();

//* Question: 9********************
question[8] = 'ข้อใดแสดงถึง "การพอเพียงในความคิด"';
question_score[8] = '1';
choice[8] = new Array();

//* Question: 10********************
question[9] = 'เหตุใดจึงกล่าวว่า "การน้อมนำเศรษฐกิจพอเพียงมาใช้ จะเป็นภูมิคุ้มกันให้เรารับมือกับการเปลี่ยนแปลงที่รุนแรงรวดเร็ว ทั้งภายในและภายนอก ได้เป็นอย่างดี" (ความเข้าใจ)';
question_score[9] = '1';
choice[9] = new Array();
choice[0][0] = new Array();
choice[0][0][0] = 'นำปรัชญาของเศรษฐกิจพอเพียงมาเป็นหลักในการพัฒนาตนเอง ทั้งในเรื่องส่วนตัวและอาชีพการงานก่อนแล้วขยายสู่สังคม';
choice[0][0][1] = '1';

choice[0][1] = new Array();
choice[0][1][0] = 'เผยแพร่ความรู้ปรัชญาเศรษฐกิจพอเพียงให้กับผู้เข้ารับการอบรม';
choice[0][1][1] = '0';

choice[0][2] = new Array();
choice[0][2][0] = 'แนะนำปรัชญาเศรษฐกิจพอเพียงให้กับชุมชน';
choice[0][2][1] = '0';

choice[0][3] = new Array();
choice[0][3][0] = 'นำปรัชญาของเศรษฐกิจพอเพียงมาเป็นหลักในการเป็นวิทยากร';
choice[0][3][1] = '0';

choice[1][0] = new Array();
choice[1][0][0] = 'ผู้บริหารทุกระดับปฏิบัติหน้าที่ตามกฎหมาย ระเบียบ ด้านความโปร่งใส และพร้อมให้ตรวจสอบได้เสมอ ';
choice[1][0][1] = '1';

choice[1][1] = new Array();
choice[1][1][0] = 'ตรวจสอบการปฏิบัติหน้าที่ของเพื่อนร่วมงาน หัวหน้า และลูกน้องอย่างสม่ำเสมอ';
choice[1][1][1] = '0';

choice[1][2] = new Array();
choice[1][2][0] = 'ผู้บริหารทุกระดับต้องให้ข้อมูลส่วนบุคคลของตนเองกับผู้อื่น';
choice[1][2][1] = '0';

choice[1][3] = new Array();
choice[1][3][0] = 'ตื่นรู้ต่อปัญหาคอร์รัปชันที่เกิดในหน่วยงานของตน';
choice[1][3][1] = '0';

choice[2][0] = new Array();
choice[2][0][0] = 'ตื่นรู้ต่อปัญหาคอร์รัปชันที่เกิดในหน่วยงานและพื้นที่รับผิดชอบของตนเอง';
choice[2][0][1] = '1';

choice[2][1] = new Array();
choice[2][1][0] = 'รับรู้ปัญหาของประเทศในด้านการทุจริตของหน่วยงานรัฐ';
choice[2][1][1] = '0';

choice[2][2] = new Array();
choice[2][2][0] = 'มีส่วนร่วมทางสังคม  ';
choice[2][2][1] = '0';

choice[2][3] = new Array();
choice[2][3][0] = 'มุ่งสู่วัฒนธรรมที่ไม่ทนต่อการทุจริต  ';
choice[2][3][1] = '0';

choice[3][0] = new Array();
choice[3][0][0] = 'มุ่งสู่วัฒนธรรมที่ไม่ทนต่อการทุจริต';
choice[3][0][1] = '1';

choice[3][1] = new Array();
choice[3][1][0] = 'มีส่วนร่วมทางสังคม';
choice[3][1][1] = '0';

choice[3][2] = new Array();
choice[3][2][0] = 'ตรวจสอบการปฏิบัติหน้าที่ของเพื่อนร่วมงาน หัวหน้า และลูกน้องอย่างสม่ำเสมอ';
choice[3][2][1] = '0';

choice[3][3] = new Array();
choice[3][3][0] = 'มีความพอเพียงบนพื้นฐานของความรู้  ';
choice[3][3][1] = '0';

choice[4][0] = new Array();
choice[4][0][0] = 'มีความรู้ความเข้าใจในสถานการณ์การทุจริตที่เกิดขึ้นทั้งในหน่วยงานและพื้นที่รับผิดชอบ รวมทั้งผลกระทบต่อประชาชนและประเทศชาติ  ';
choice[4][0][1] = '1';

choice[4][1] = new Array();
choice[4][1][0] = 'พัฒนาความรู้ของตนเองอย่างสม่ำเสมอ เพื่อก้าวไปสู่ตำแหน่งที่สูงขึ้น  ';
choice[4][1][1] = '0';

choice[4][2] = new Array();
choice[4][2][0] = 'ตื่นรู้ต่อปัญหาคอร์รัปชันที่เกิดในหน่วยงานของตน  ';
choice[4][2][1] = '0';

choice[4][3] = new Array();
choice[4][3][0] = 'มีความพอเพียงบนพื้นฐานของความรู้';
choice[4][3][1] = '0';

choice[5][0] = new Array();
choice[5][0][0] = 'มีความเอื้ออาทรกับประชาชนผู้ใช้บริการ แต่ไม่เอื้ออาทรต่อการรับหรือให้ผลประโยชน์อย่างทุจริต';
choice[5][0][1] = '1';

choice[5][1] = new Array();
choice[5][1][0] = 'เอื้ออาทรกับเจ้านายและพวกพ้องในทุกกรณี';
choice[5][1][1] = '0';

choice[5][2] = new Array();
choice[5][2][0] = 'ตั้งกองทุนหรือมูลนิธิเพื่อสังคม';
choice[5][2][1] = '0';

choice[5][3] = new Array();
choice[5][3][0] = 'ตื่นรู้ต่อปัญหาคอร์รัปชันระดับประเทศ';
choice[5][3][1] = '0';

choice[6][0] = new Array();
choice[6][0][0] = 'เพราะทุกคนในสังคมจะใช้ชีวิตอย่างไม่เบียดเบียนกัน ไม่เอาเปรียบกัน ';
choice[6][0][1] = '1';

choice[6][1] = new Array();
choice[6][1][0] = 'เพราะทุกคนทำเกษตรกรรม จึงมีความสุขอยู่กับธรรมชาติอยู่แล้ว';
choice[6][1][1] = '0';

choice[6][2] = new Array();
choice[6][2][0] = 'เพราะการไม่นำเทคโนโลยีมาใช้ ทำให้ไม่ต้องขวนขวายหานวัตกรรมหรือเทคโนโลยีใหม่ ๆ ตลอดเวลา จึงมีความสงบสุข';
choice[6][2][1] = '0';

choice[6][3] = new Array();
choice[6][3][0] = 'เพราะมีการวางแผนทุกขั้นตอน จึงปฏิบัติตามแผนได้อย่างมีความสุข';
choice[6][3][1] = '0';

choice[7][0] = new Array();
choice[7][0][0] = 'จริง โดยดูจากนาฬิกา รองเท้า เสื้อ และห้องทำงานที่พระองค์ใช้ตลอดพระชนม์ชีพ ที่ไม่ได้เป็นของราคาแพงหรือหรูหรา ฟุ่มเฟือย เป็นเพียงให้ใช้งานได้ตามวัตถุประสงค์เท่านั้น';
choice[7][0][1] = '1';

choice[7][1] = new Array();
choice[7][1][0] = 'จริง โดยดูจากโครงการส่วนพระองค์ที่มีกระจายทั่วประเทศ เพื่อให้เป็นแหล่งเรียนรู้ของทุกคนที่ต้องการหาความรู้ไปพัฒนาตนเอง ';
choice[7][1][1] = '0';

choice[7][2] = new Array();
choice[7][2][0] = 'ไม่จริง เพราะพระองค์เป็นพระมหากษัตริย์ จึงไม่สามารถเป็นแบบอย่างได้';
choice[7][2][1] = '0';

choice[7][3] = new Array();
choice[7][3][0] = 'ไม่จริง เพราะการเป็นพระมหากษัตริย์จะมีความพอเพียงไม่ได้ เช่น อาหารต้องมีความพิเศษวิจิตรบรรจง';
choice[7][3][1] = '0';

choice[8][0] = new Array();
choice[8][0][0] = 'การที่ตนเองแสดงความคิดเห็นให้คนอื่นฟังและเปิดโอกาสให้คนอื่นแสดงความคิดเห็นด้วย แล้วจึงพิจารณาด้วยเหตุผลว่าความคิดเห็นใดพอเพียงและมีสาระ โดยไม่ต้องทะเลาะกัน';
choice[8][0][1] = '1';

choice[8][1] = new Array();
choice[8][1][0] = 'การคิดที่ไม่ต้องขวนขวายหรือกระตือรือร้น ใช้ชีวิตแบบง่าย ๆ ในแต่ละวัน';
choice[8][1][1] = '0';

choice[8][2] = new Array();
choice[8][2][0] = 'การคิดให้พอดีกับสิ่งที่ตนเองทำได้จริง ไม่คิดเกินกว่าความเป็นจริง';
choice[8][2][1] = '0';

choice[8][3] = new Array();
choice[8][3][0] = 'การเก็บความคิดของตนเองไว้ โดยไม่ต้องไปแสดงความคิดเห็นของตนให้กับผู้อื่นฟัง เพราะอาจทำให้ผู้ที่มีความคิดเห็นไม่ตรงกันเกิดการทะเลาะกับเราได้';
choice[8][3][1] = '0';

choice[9][0] = new Array();
choice[9][0][0] = 'การเดินทางสายกลางตามหลักเศรษฐกิจพอเพียง ทำให้เมื่อเกิดการเปลี่ยนแปลงจะได้รับผลกระทบน้อย เช่น เศรษฐกิจตกต่ำ เราก็ไม่กระทบมากเพราะเราใช้ชีวิตแบบพอประมาณ ไม่ฟุ่มเฟือยอยู่แล้ว';
choice[9][0][1] = '1';

choice[9][1] = new Array();
choice[9][1][0] = 'เศรษฐกิจพอเพียงทำให้เราทำเกษตรกรรม จึงมีอาหารอยู่ภายในบ้านอยู่แล้ว การเปลี่ยนแปลงใด ๆ จึงไม่เดือดร้อน';
choice[9][1][1] = '0';

choice[9][2] = new Array();
choice[9][2][0] = 'เศรษฐกิจพอเพียงต้องมีการเก็บออม ทำให้สามารถนำเงินออมมาใช้เมื่อยามวิกฤติ';
choice[9][2][1] = '0';

choice[9][3] = new Array();
choice[9][3][0] = 'การนำเศรษฐกิจพอเพียงมาใช้ ทำให้ชีวิตไม่มีความเกี่ยวข้องกับสังคมภายนอก จึงไม่ได้รับผลกระทบใด ๆ จากการเปลี่ยนแปลงภายนอก';
choice[9][3][1] = '0';
...
function genQuestion(no, a, chkans, ans) {
	...
	if (question[a]) {
		...
		txtq += '<td align="left" valign=middle colspan="2"> ';
		...
		for (c = 0; c < choice[a].length; c++) {
			...
			if (chkans) {
				...
				txtch += '<tr valign="middle" onClick="setAns('+no+','+c+')" style="cursor: pointer;">';
			} else {
			...
			txtch += ch_radio;
			txtch += '</td>';
			txtch += '<td valign="middle" align="left"> ';
			txtch += choice[a][c][0];
			txtch += '</td>';
			txtch += '</tr>';
		}

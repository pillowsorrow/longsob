...
//* Question: 1********************
question[0] = 'ข้อใดไม่ใช่ความหมายของ STRONG';
question_score[0] = '1';
choice[0] = new Array();

//* Question: 2********************
question[1] = 'ข้อใดคือตัวอย่างของ T - Transparent โปร่งใส';
question_score[1] = '1';
choice[1] = new Array();

//* Question: 3********************
question[2] = 'ข้อใดคือตัวอย่างของ R - Realise ตื่นรู้';
question_score[2] = '1';
choice[2] = new Array();

//* Question: 4********************
question[3] = 'ข้อใดคือตัวอย่างของ O - Onward มุ่งไปข้างหน้า';
question_score[3] = '1';
choice[3] = new Array();

//* Question: 5********************
question[4] = 'ข้อใดคือตัวอย่างของ N - Knowledge ความรู้';
question_score[4] = '1';
choice[4] = new Array();

//* Question: 6********************
question[5] = 'ข้อใดคือตัวอย่างของ G - Generosity เอื้ออาทร';
question_score[5] = '1';
choice[5] = new Array();

//* Question: 7********************
question[6] = 'ข้อใดคือตัวอย่างของ S - Sufficient พอเพียง';
question_score[6] = '1';
choice[6] = new Array();

//* Question: 8********************
question[7] = 'การแบ่งปัน คือข้อใด';
question_score[7] = '1';
choice[7] = new Array();

//* Question: 9********************
question[8] = 'ไม่ทำการบ้าน เอาแต่เล่น เลยไม่ยอมให้คุณพ่อคุณแม่มาตรวจสอบ คือการไม่ปฏิบัติตนตามหลัก STRONG  ในข้อใด  ';
question_score[8] = '1';
choice[8] = new Array();

//* Question: 10********************
question[9] = 'ข้อใดไม่ใช่ผลของการปฏิบัติตัวตามหลัก STRONG';
question_score[9] = '1';
choice[9] = new Array();
choice[0][0] = new Array();
choice[0][0][0] = 'Study การศึกษา';
choice[0][0][1] = '1';

choice[0][1] = new Array();
choice[0][1][0] = 'Realise ตื่นรู้';
choice[0][1][1] = '0';

choice[0][2] = new Array();
choice[0][2][0] = 'Knowledge ความรู้';
choice[0][2][1] = '0';

choice[1][0] = new Array();
choice[1][0][0] = 'ฝึกซ้อมกีฬา ออกกำลังกายสม่ำเสมอ';
choice[1][0][1] = '0';

choice[1][1] = new Array();
choice[1][1][0] = 'เวลาทำการบ้าน ให้คุณพ่อคุณแม่มาตรวจดูได้ ';
choice[1][1][1] = '1';

choice[1][2] = new Array();
choice[1][2][0] = 'ดูหนังที่ช่วยให้เรามีความรู้มากขึ้น';
choice[1][2][1] = '0';

choice[2][0] = new Array();
choice[2][0][0] = 'ให้คุณครูช่วยสอนเมื่อทำการบ้านไม่ได้';
choice[2][0][1] = '1';

choice[2][1] = new Array();
choice[2][1][0] = 'ช่วยคุณพ่อคุณแม่ทำงานบ้าน';
choice[2][1][1] = '0';

choice[2][2] = new Array();
choice[2][2][0] = 'แบ่งของเล่นให้เพื่อน';
choice[2][2][1] = '0';

choice[3][0] = new Array();
choice[3][0][0] = 'อ่านหนังสือที่มีประโยชน์';
choice[3][0][1] = '0';

choice[3][1] = new Array();
choice[3][1][0] = 'ไม่แย่งของเล่นของเพื่อน';
choice[3][1][1] = '0';

choice[3][2] = new Array();
choice[3][2][0] = 'ฝึกซ้อมกีฬาสม่ำเสมอ เพราะอยากเป็นนักกีฬาทีมชาติ';
choice[3][2][1] = '1';

choice[4][0] = new Array();
choice[4][0][0] = 'ช่วยเหลือผู้อื่น';
choice[4][0][1] = '0';

choice[4][1] = new Array();
choice[4][1][0] = 'อ่านหนังสือที่มีประโยชน์';
choice[4][1][1] = '1';

choice[4][2] = new Array();
choice[4][2][0] = 'เล่นกับเพื่อนด้วยจิตพอเพียง';
choice[4][2][1] = '0';

choice[5][0] = new Array();
choice[5][0][0] = 'แย่งของเล่นเพื่อน';
choice[5][0][1] = '0';

choice[5][1] = new Array();
choice[5][1][0] = 'การอ่านหนังสือที่มีประโยชน์';
choice[5][1][1] = '0';

choice[5][2] = new Array();
choice[5][2][0] = 'การช่วยเหลือผู้อื่น';
choice[5][2][1] = '1';

choice[6][0] = new Array();
choice[6][0][0] = 'ให้คุณครูช่วยสอนเมื่อไม่เข้าใจการบ้าน';
choice[6][0][1] = '0';

choice[6][1] = new Array();
choice[6][1][0] = 'ดูหนังที่ช่วยให้เรามีความรู้มากขึ้น';
choice[6][1][1] = '0';

choice[6][2] = new Array();
choice[6][2][0] = 'การคิดและทำอย่างพอเพียง';
choice[6][2][1] = '1';

choice[7][0] = new Array();
choice[7][0][0] = 'G - Generosity';
choice[7][0][1] = '1';

choice[7][1] = new Array();
choice[7][1][0] = 'R - Realise';
choice[7][1][1] = '0';

choice[7][2] = new Array();
choice[7][2][0] = 'S - Sufficient';
choice[7][2][1] = '0';

choice[8][0] = new Array();
choice[8][0][0] = 'O - Onward มุ่งไปข้างหน้า';
choice[8][0][1] = '0';

choice[8][1] = new Array();
choice[8][1][0] = 'T - Transparent โปร่งใส';
choice[8][1][1] = '1';

choice[8][2] = new Array();
choice[8][2][0] = 'N - Knowledge ความรู้';
choice[8][2][1] = '0';

choice[9][0] = new Array();
choice[9][0][0] = 'มีจิตทุจริต';
choice[9][0][1] = '1';

choice[9][1] = new Array();
choice[9][1][0] = 'รู้จักความพอเพียง';
choice[9][1][1] = '0';

choice[9][2] = new Array();
choice[9][2][0] = 'ต่อต้านการทุจริต';
choice[9][2][1] = '0';

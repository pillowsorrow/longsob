(function (win, doc) {
  ...
  */
  ...
  function onResize() {
     ...
     */
    scale = Math.pow(winWidth / BREAKPOINT, 0.6);
     ...
     * in px.
     */
    height = IFRAME_HEIGHT + 150 / scale;
	...
	document.getElementById("qq").style.top = 110 * scale + 'px';
	document.getElementById("qq").style.left = 100 * scale + 'px';

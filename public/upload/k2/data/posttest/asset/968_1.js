...
//* Question: 1********************
question[0] = 'ใครทำตัวไม่น่ารัก';
question_score[0] = '1';
choice[0] = new Array();

//* Question: 2********************
question[1] = 'เพื่อนคนไหนที่เราควรเล่นด้วย';
question_score[1] = '1';
choice[1] = new Array();

//* Question: 3********************
question[2] = 'เมื่อเล่นของเล่นเสร็จแล้ว ควรทำอย่างไร';
question_score[2] = '1';
choice[2] = new Array();

//* Question: 4********************
question[3] = 'ถ้าเราชอบของเล่นชิ้นนึงของโรงเรียนมาก เราควรทำอย่างไร';
question_score[3] = '1';
choice[3] = new Array();

//* Question: 5********************
question[4] = 'ถ้าเห็นเพื่อนโดนรังแก เราควรทำอย่างไร<center><img src=\"asset/3066_19990.jpg\" border=0 name=\"img0\"></center>';
question_score[4] = '1';
choice[4] = new Array();

//* Question: 6********************
question[5] = 'เราควรเล่นกับเพื่อนอย่างไร';
question_score[5] = '1';
choice[5] = new Array();

//* Question: 7********************
question[6] = 'ข้อใดปฏิบัติตนไม่ถูกต้อง';
question_score[6] = '1';
choice[6] = new Array();

//* Question: 8********************
question[7] = 'ถ้าเรามีของเล่นเยอะมากๆ เราควรทำอย่างไร';
question_score[7] = '1';
choice[7] = new Array();

//* Question: 9********************
question[8] = 'หากเราเห็นเพื่อนรังแกกัน แต่เราไม่ยอมบอกคุณครูหรือผู้ปกครอง แสดงว่าเราเป็นคนอย่างไร';
question_score[8] = '1';
choice[8] = new Array();

//* Question: 10********************
question[9] = 'การมีน้ำใจ แบ่งปันให้กับเพื่อน จะทำให้เราเป็นคนอย่างไร';
question_score[9] = '1';
choice[9] = new Array();
choice[0][0] = new Array();
choice[0][0][0] = '<center><img src=\"asset/3066_19978.jpg\" border=0 name=\"img0\" height=100></center>';
choice[0][0][1] = '0';

choice[0][1] = new Array();
choice[0][1][0] = '<center><img src=\"asset/3066_19979.jpg\" border=0 name=\"img0\" height=100></center>';
choice[0][1][1] = '1';

choice[0][2] = new Array();
choice[0][2][0] = '<center><img src=\"asset/3066_19980.jpg\" border=0 name=\"img0\" height=100></center>';
choice[0][2][1] = '0';

choice[1][0] = new Array();
choice[1][0][0] = '<center><img src=\"asset/3066_19981.jpg\" border=0 name=\"img0\" height=100></center>';
choice[1][0][1] = '0';

choice[1][1] = new Array();
choice[1][1][0] = '<center><img src=\"asset/3066_19982.jpg\" border=0 name=\"img0\" height=100></center>';
choice[1][1][1] = '0';

choice[1][2] = new Array();
choice[1][2][0] = '<center><img src=\"asset/3066_19983.jpg\" border=0 name=\"img0\" height=100></center>';
choice[1][2][1] = '1';

choice[2][0] = new Array();
choice[2][0][0] = '<center><img src=\"asset/3066_19984.jpg\" border=0 name=\"img0\" height=100></center>';
choice[2][0][1] = '1';

choice[2][1] = new Array();
choice[2][1][0] = '<center><img src=\"asset/3066_19985.jpg\" border=0 name=\"img0\" height=100></center>';
choice[2][1][1] = '0';

choice[2][2] = new Array();
choice[2][2][0] = '<center><img src=\"asset/3066_19986.jpg\" border=0 name=\"img0\" height=100></center>';
choice[2][2][1] = '0';

choice[3][0] = new Array();
choice[3][0][0] = '<center><img src=\"asset/3066_19987.jpg\" border=0 name=\"img0\" height=100></center>';
choice[3][0][1] = '0';

choice[3][1] = new Array();
choice[3][1][0] = '<center><img src=\"asset/3066_19988.jpg\" border=0 name=\"img0\" height=100></center>';
choice[3][1][1] = '0';

choice[3][2] = new Array();
choice[3][2][0] = '<center><img src=\"asset/3066_19989.jpg\" border=0 name=\"img0\" height=100></center>';
choice[3][2][1] = '1';

choice[4][0] = new Array();
choice[4][0][0] = 'เก็บเป็นความลับ ไม่บอกใคร';
choice[4][0][1] = '0';

choice[4][1] = new Array();
choice[4][1][0] = 'แจ้งให้คุณครูทราบ';
choice[4][1][1] = '1';

choice[4][2] = new Array();
choice[4][2][0] = 'เข้าไปจัดการด้วยตัวเอง';
choice[4][2][1] = '0';

choice[5][0] = new Array();
choice[5][0][0] = 'มีน้ำใจ แบ่งปัน';
choice[5][0][1] = '1';

choice[5][1] = new Array();
choice[5][1][0] = 'รังแกคนที่ไม่มีแรงสู้';
choice[5][1][1] = '0';

choice[5][2] = new Array();
choice[5][2][0] = 'เอาเปรียบ';
choice[5][2][1] = '0';

choice[6][0] = new Array();
choice[6][0][0] = '<center><img src=\"asset/3066_19991.jpg\" border=0 name=\"img0\" height=100></center>';
choice[6][0][1] = '0';

choice[6][1] = new Array();
choice[6][1][0] = '<center><img src=\"asset/3066_19992.jpg\" border=0 name=\"img0\" height=100></center>';
choice[6][1][1] = '1';

choice[6][2] = new Array();
choice[6][2][0] = '<center><img src=\"asset/3066_19993.jpg\" border=0 name=\"img0\" height=100></center>';
choice[6][2][1] = '0';

choice[7][0] = new Array();
choice[7][0][0] = 'แบ่งให้เพื่อนเล่น ไม่เล่นเองคนเดียว';
choice[7][0][1] = '0';

choice[7][1] = new Array();
choice[7][1][0] = 'นำไปบริจาค';
choice[7][1][1] = '0';

choice[7][2] = new Array();
choice[7][2][0] = 'ถูกทุกข้อ';
choice[7][2][1] = '1';

choice[8][0] = new Array();
choice[8][0][0] = 'ยอมรับการทำร้ายกันได้';
choice[8][0][1] = '1';

choice[8][1] = new Array();
choice[8][1][0] = 'เป็นคนรักความยุติธรรม';
choice[8][1][1] = '0';

choice[8][2] = new Array();
choice[8][2][0] = 'เป็นคนไม่ยอมต่อการกระทำความผิด';
choice[8][2][1] = '0';

choice[9][0] = new Array();
choice[9][0][0] = 'เป็นคนเห็นแก่ตัว';
choice[9][0][1] = '0';

choice[9][1] = new Array();
choice[9][1][0] = 'เป็นคนไม่ซื่อสัตย์';
choice[9][1][1] = '0';

choice[9][2] = new Array();
choice[9][2][0] = 'เป็นคนดีที่ใครๆ ก็รักและอยากเล่นด้วย';
choice[9][2][1] = '1';

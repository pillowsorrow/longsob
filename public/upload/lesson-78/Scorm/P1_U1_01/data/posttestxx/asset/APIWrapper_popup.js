...
function doLMSGetValue(name)
{
	return opener.doLMSGetValue(name);
	/*
   var api = getAPIHandle();
   if (api == null)
   {
...
function doLMSSetValue(name, value)
{
	return opener.doLMSSetValue(name,value);
	/*
//alert(name+" : " +value);
   var api = getAPIHandle();
   if (api == null)
...
function doLMSGetLastError()
{
	return opener.doLMSGetLastError();
	/*
   var api = getAPIHandle();
   if (api == null)
   {
...
function doLMSGetErrorString(errorCode)
{
	return opener.doLMSGetErrorString(errorCode);
	/*
   var api = getAPIHandle();
   if (api == null)
   {
...
function doLMSGetDiagnostic(errorCode)
{
	return opener.doLMSGetDiagnostic(errorCode);
	/*
   var api = getAPIHandle();
   if (api == null)
   {
...
function LMSIsInitialized()
{
	return opener.LMSIsInitialized();

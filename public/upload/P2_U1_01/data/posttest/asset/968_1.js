...
//* Question: 1********************
question[0] = 'ข้อใด<U>ไม่ใช่</U>ของใช้ส่วนรวมในโรงเรียน ';
question_score[0] = '1';
choice[0] = new Array();
...
//* Question: 3********************
question[2] = 'ข้อใดปฏิบัติได้ถูกต้อง';
question_score[2] = '1';
choice[2] = new Array();

//* Question: 4********************
question[3] = 'การเล่นที่สนามเด็กเล่น ควรปฏิบัติตัวอย่างไร';
question_score[3] = '1';
choice[3] = new Array();

//* Question: 5********************
question[4] = 'ข้อใดคือของใช้ส่วนรวมในโรงเรียน';
question_score[4] = '1';
choice[4] = new Array();

//* Question: 6********************
question[5] = 'ข้อใดปฏิบัติ<U>ไม่</U>ถูกต้อง ';
question_score[5] = '1';
choice[5] = new Array();

//* Question: 7********************
question[6] = 'การใช้รถรับ-ส่งของโรงเรียน ควรปฏิบัติตัวอย่างไร';
question_score[6] = '1';
choice[6] = new Array();

//* Question: 8********************
question[7] = 'ผ้าเช็ดหน้า จัดเป็นของใช้ประเภทใด';
question_score[7] = '1';
choice[7] = new Array();

//* Question: 9********************
question[8] = 'แปรงลบกระดาน จัดเป็นของใช้ประเภทใด';
question_score[8] = '1';
choice[8] = new Array();

//* Question: 10********************
question[9] = 'การใช้คอมพิวเตอร์ของโรงเรียน ควรปฏิบัติตัวอย่างไร';
question_score[9] = '1';
choice[9] = new Array();
choice[0][0] = new Array();
choice[0][0][0] = 'ห้องนอน';
choice[0][0][1] = '1';

choice[0][1] = new Array();
choice[0][1][0] = 'ห้องสมุด';
choice[0][1][1] = '0';

choice[0][2] = new Array();
choice[0][2][0] = 'ห้องเรียน ';
choice[0][2][1] = '0';

choice[1][0] = new Array();
choice[1][0][0] = 'สนามเด็กเล่น';
choice[1][0][1] = '0';

choice[1][1] = new Array();
choice[1][1][0] = 'ไม้แบดมินตันของโรงเรียน';
choice[1][1][1] = '0';

choice[1][2] = new Array();
choice[1][2][0] = 'หน้ากากอนามัย ';
choice[1][2][1] = '1';

choice[2][0] = new Array();
choice[2][0][0] = 'ทิ้งขยะไว้ใต้โต๊ะเรียน';
choice[2][0][1] = '0';

choice[2][1] = new Array();
choice[2][1][0] = 'ทำความสะอาดก่อนออกจากห้องน้ำ';
choice[2][1][1] = '1';

choice[2][2] = new Array();
choice[2][2][0] = 'ทานอาหารในห้องสมุด';
choice[2][2][1] = '0';

choice[3][0] = new Array();
choice[3][0][0] = 'เล่นแค่พอดี แบ่งให้คนอื่นเล่นบ้าง';
choice[3][0][1] = '1';

choice[3][1] = new Array();
choice[3][1][0] = 'เล่นคนเดียวไม่แบ่งใคร';
choice[3][1][1] = '0';

choice[3][2] = new Array();
choice[3][2][0] = 'แซงคิวเพื่อให้ได้เล่นเร็วขึ้น';
choice[3][2][1] = '0';

choice[4][0] = new Array();
choice[4][0][0] = 'แปรงสีฟัน';
choice[4][0][1] = '0';
...
choice[4][2][0] = 'กระดานดำ';
choice[4][2][1] = '1';

choice[5][0] = new Array();
choice[5][0][0] = 'ยืมและคืนหนังสือของห้องสมุด ไม่ขโมยกลับบ้าน';
choice[5][0][1] = '0';

choice[5][1] = new Array();
choice[5][1][0] = 'เมื่อทานอาหารเสร็จแล้ว นำภาชนะส่งคืนให้เรียบร้อย';
choice[5][1][1] = '0';

choice[5][2] = new Array();
choice[5][2][0] = 'เปิดก๊อกน้ำในห้องน้ำทิ้งไว้';
choice[5][2][1] = '1';

choice[6][0] = new Array();
choice[6][0][0] = 'เข้าแถวขึ้นรถ เมื่อได้ที่นั่งก็นั่งให้เรียบร้อย';
choice[6][0][1] = '1';

choice[6][1] = new Array();
choice[6][1][0] = 'ใช้กระเป๋านักเรียนจองที่ให้เพื่อน';
choice[6][1][1] = '0';

choice[6][2] = new Array();
choice[6][2][0] = 'ส่งเสียงดังตลอดทาง';
choice[6][2][1] = '0';

choice[7][0] = new Array();
choice[7][0][0] = 'ของใช้ส่วนรวม';
choice[7][0][1] = '0';

choice[7][1] = new Array();
choice[7][1][0] = 'ของใช้ส่วนตัว';
choice[7][1][1] = '1';

choice[7][2] = new Array();
choice[7][2][0] = 'ของใช้อันตราย';
choice[7][2][1] = '0';

choice[8][0] = new Array();
choice[8][0][0] = 'ของใช้ส่วนรวม';
choice[8][0][1] = '1';

choice[8][1] = new Array();
choice[8][1][0] = 'ของใช้ส่วนตัว';
choice[8][1][1] = '0';

choice[8][2] = new Array();
choice[8][2][0] = 'ของใช้อันตราย';
choice[8][2][1] = '0';

choice[9][0] = new Array();
choice[9][0][0] = 'ดาวน์โหลดเกมที่ชอบลงเครื่อง';
choice[9][0][1] = '0';

choice[9][1] = new Array();
choice[9][1][0] = 'ปิดเครื่องเมื่อใช้งานเสร็จแล้ว ';
choice[9][1][1] = '1';

choice[9][2] = new Array();
choice[9][2][0] = 'ทำป้ายจองเพื่อใช้เป็นเครื่องประจำ';
choice[9][2][1] = '0';
...
function Play(pid) {
	// alert("OK");
	var myAudio = document.getElementById(pid);
	if (myAudio.paused) {
		myAudio.play();
	}
	else {
